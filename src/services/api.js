...
// 1. Dynamically read the base URL from the environment configuration context
  ...
  async (error) => {
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
      ...
      try {
        ...
        // 2. Used the environment variable here to prevent a hardcoded fallback breakout
